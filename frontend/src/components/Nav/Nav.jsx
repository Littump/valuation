        ...
        <ul className="md:ml-auto flex md:gap-10 gap-8 flex-row-reverse md:flex-row items-center">
          <li>
            <label className="swap swap-rotate translate-y-1 group">
              ...
              {/* sun icon */}
              <svg
                className="swap-on w-6 h-6 transition fill-dark-gray-400 group-hover:fill-blue-500 dark:group-hover:fill-dark-300"
              ...
              {/* moon icon */}
              <svg
                className="swap-off w-6 h-6 transition fill-dark-200 group-hover:fill-blue-500 dark:group-hover:fill-dark-300"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
