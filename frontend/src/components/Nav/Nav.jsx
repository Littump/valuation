  ...
  return (
    <>
      <div
        ...
        nav
        z-10
        fixed top-0 left-0 w-full flex justify-center items-center flex-row-reverse md:flex-row
        shadow-sm py-5 dark:shadow-md
        bg-white dark:bg-dark-400
        px-7 text-gray-600 dark:text-dark-100
        "
      >
        <button
        ...
        <DesktopMenu />
        <ul className="md:ml-auto flex md:gap-10 gap-8 flex-row-reverse md:flex-row items-center">
          <li>
            <label className="swap swap-rotate translate-y-1 group">
              ...
              {/* moon icon */}
              <svg
                className="swap-on w-6 h-6 transition fill-dark-200 group-hover:fill-blue-500 dark:group-hover:fill-dark-300"
              ...
              {/* sun icon */}
              <svg
                className="swap-off w-6 h-6 transition fill-dark-gray-400 group-hover:fill-blue-500 dark:group-hover:fill-dark-300"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
