# Generated by Django 3.2 on 2023-10-14 22:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('analyst', 'Аналитик'), ('appraiser', 'Оценщик'), ('investor', 'Инвестор'), ('employee', 'Сотрудник')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_lift', models.CharField(blank=True, max_length=255)),
                ('parking_type', models.CharField(blank=True, max_length=255)),
